# Available .SRL One-Word Domains (5,622,032)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C565%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C032%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,565-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,032 domains** on the canonical page below.

**Public extract:** 9,565 rows · **Live catalog:** 5,622,032 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/srl?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_srl_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/srl?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_srl_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./srl.csv">CSV</a> / <a href="./srl.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_srl_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_srl_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .SRL search](https://unique.domains/domains/tld/srl?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_srl_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .SRL search](https://unique.domains/domains/tld/srl?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_srl_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./srl.csv) or [Download JSON](./srl.json)
...
- `srl.csv` — public CSV extract (9,565 rows)
- `srl.json` — public JSON extract (9,565 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,565-row public sample | 5,622,032 live domains                           |
...
| live.srl       | premium   | $57.50    | $32.50        | 108            | 55     | 4      | name.com    |
...
| clear.srl      | available | $49.99    | $49.99        | 90             | 50     | 5      | name.com    |
| game.srl       | premium   | $57.50    | $32.50        | 120            | 50     | 4      | name.com    |
| platform.srl   | available | $49.99    | —             | 78             | 49     | 8      | name.com    |
...
| genius.srl     | available | $49.99    | $49.99        | 98             | 47     | 6      | name.com    |
| all.srl        | premium   | $57.50    | $32.50        | 88             | 48     | 3      | name.com    |
| wizard.srl     | available | $49.99    | $49.99        | 118            | 46     | 6      | name.com    |
...
> Unique Domains. *Available .SRL One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
